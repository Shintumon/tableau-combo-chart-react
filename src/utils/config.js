...
export const Config = {
  ...
  current: {
    ...
    barLabelsNegativeStyle: 'minus',
    barLabelsDisplayUnits: 'none',
    barLabelsPrefix: '',
    barLabelsSuffix: '',
    barLabelsThousandsSep: true,
    barLabelsCustomFormat: '',
    barLabelsDateFormat: 'shortDate',
    barLabelsCustomDateFormat: '',
    barLabelsOffsetX: 0,
    barLabelsOffsetY: 0,
