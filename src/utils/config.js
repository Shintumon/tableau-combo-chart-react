...
export const Config = {
  ...
  current: {
    ...
    xAxisDecimals: 0,
    xAxisCurrencySymbol: '$',
    xAxisCurrencyPosition: 'prefix',
    xAxisNegativeStyle: 'minus',
    xAxisDisplayUnits: 'none',
    xAxisPrefix: '',
    xAxisSuffix: '',
    xAxisThousandsSep: true,
    xAxisCustomFormat: '',
    xAxisDateFormat: 'shortDate',
    xAxisCustomDateFormat: '',
    ...
    yAxisLeftCurrencyPosition: 'prefix',
    yAxisLeftNegativeStyle: 'minus',
    yAxisLeftDisplayUnits: 'none',
    yAxisLeftPrefix: '',
    yAxisLeftSuffix: '',
    yAxisLeftThousandsSep: true,
    yAxisLeftCustomFormat: '',
    yAxisLeftDateFormat: 'shortDate',
    yAxisLeftCustomDateFormat: '',
    ...
    yAxisRightCurrencyPosition: 'prefix',
    yAxisRightNegativeStyle: 'minus',
    yAxisRightDisplayUnits: 'none',
    yAxisRightPrefix: '',
    yAxisRightSuffix: '',
    yAxisRightThousandsSep: true,
    yAxisRightCustomFormat: '',
    yAxisRightDateFormat: 'shortDate',
    yAxisRightCustomDateFormat: '',
    ...
    // Bar 1 Labels
    bar1LabelsShow: false,
    bar1LabelsPosition: 'top', // 'top', 'inside', 'center'
    bar1LabelsFormat: 'auto',
    bar1LabelsDecimals: 0,
    bar1LabelsCurrencySymbol: '$',
    bar1LabelsCurrencyPosition: 'prefix',
    bar1LabelsNegativeStyle: 'minus',
    bar1LabelsDisplayUnits: 'none',
    bar1LabelsPrefix: '',
    bar1LabelsSuffix: '',
    bar1LabelsThousandsSep: true,
    bar1LabelsCustomFormat: '',
    bar1LabelsDateFormat: 'shortDate',
    bar1LabelsCustomDateFormat: '',
    bar1LabelsOffsetX: 0,
    bar1LabelsOffsetY: 0,

    // Bar 2 Labels
    bar2LabelsShow: false,
    bar2LabelsPosition: 'top', // 'top', 'inside', 'center'
    bar2LabelsFormat: 'auto',
    bar2LabelsDecimals: 0,
    bar2LabelsCurrencySymbol: '$',
    bar2LabelsCurrencyPosition: 'prefix',
    bar2LabelsNegativeStyle: 'minus',
    bar2LabelsDisplayUnits: 'none',
    bar2LabelsPrefix: '',
    bar2LabelsSuffix: '',
    bar2LabelsThousandsSep: true,
    bar2LabelsCustomFormat: '',
    bar2LabelsDateFormat: 'shortDate',
    bar2LabelsCustomDateFormat: '',
    bar2LabelsOffsetX: 0,
    bar2LabelsOffsetY: 0,
    ...
    lineLabelsCurrencyPosition: 'prefix',
    lineLabelsNegativeStyle: 'minus',
    lineLabelsDisplayUnits: 'none',
    lineLabelsPrefix: '',
    lineLabelsSuffix: '',
    lineLabelsThousandsSep: true,
    lineLabelsCustomFormat: '',
    lineLabelsDateFormat: 'shortDate',
    lineLabelsCustomDateFormat: '',
    lineLabelsOffsetX: 0,
    lineLabelsOffsetY: 0,
